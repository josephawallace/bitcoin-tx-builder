...
const SAT_BTC_MULT: number = 1e8;
const TESTNET: bitcoin.networks.Network = bitcoin.networks.testnet;
const TXO_FILE_PATH: string = path.join(path.resolve(), 'extras', 'wallet', 'txo.json');
const apiUrl: string = 'https://blockstream.info/testnet/api';
...
const mnemonic: string = 'height dad moral vacant clump service category unhappy dumb remain soda dash';
